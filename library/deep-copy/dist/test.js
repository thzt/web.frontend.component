...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log(JSON.stringify((0, _index2.default)(1), null, 4));
	console.log(JSON.stringify((0, _index2.default)('2'), null, 4));
	console.log(JSON.stringify((0, _index2.default)(new Number(1)), null, 4));
	console.log(JSON.stringify((0, _index2.default)(new String('2')), null, 4));
	console.log(JSON.stringify((0, _index2.default)([]), null, 4));
	console.log(JSON.stringify((0, _index2.default)({}), null, 4));
	console.log(JSON.stringify((0, _index2.default)(null), null, 4));
	console.log(JSON.stringify((0, _index2.default)(NaN), null, 4));
	console.log(JSON.stringify((0, _index2.default)([1, {
	  a: function a() {},
	  b: function b() {}, c: 2, d: [3], e: { f: 4 } }]), null, 4));
	console.log(JSON.stringify((0, _index2.default)({
	  a: function a() {},
	  b: function b() {}, c: 2, d: [3], e: { f: 4 } }), null, 4));
