...
/***/ function(module, exports, __webpack_require__) {
	...
	console.warn(JSON.stringify(_index2.default.find.call(data1, 'list[*].a[1].*'), null, 4));

	var data2 = [1, 2];
	data2.test = 3;
	console.info(JSON.stringify(_index2.default.find.call(data2, '[*]'), null, 4));
	console.info(JSON.stringify(_index2.default.find.call(data2, '.*'), null, 4));

	var data3 = { a: 1, b: 2 };
	console.log(JSON.stringify(_index2.default.find.call(data3, '[*]'), null, 4));
	console.log(JSON.stringify(_index2.default.find.call(data3, '.*'), null, 4));

	var data4 = { a: null };
	console.log(JSON.stringify(_index2.default.find.call(data4, 'a'), null, 4));
	console.log(JSON.stringify(_index2.default.find.call(data4, 'b'), null, 4));

	var data = [{ a: '2016-07-09:', b: '2016-07-08' }, { a: '2016-07-09', b: '2016-07-08:' }, { c: 1 }];
	console.log(JSON.stringify(_index2.default.find.call(data, '[*].a'), null, 4));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handleProp = __webpack_require__(4);

	var _handleProp2 = _interopRequireDefault(_handleProp);

	var _handleWildcard = __webpack_require__(6);

	var _handleWildcard2 = _interopRequireDefault(_handleWildcard);

	var _convertBracketToDot = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createPath = __webpack_require__(5);
